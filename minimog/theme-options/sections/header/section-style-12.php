...
Redux::set_section( Minimog_Redux::OPTION_NAME, array(
	...
	'fields'     => array(
		array(
			'id'      => 'header_style_12_content_width',
			'type'    => 'select',
		...
		array(
			'id'      => 'header_style_12_header_above_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_info_list_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_info_list_secondary_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_search_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_login_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_wishlist_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_cart_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_currency_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_language_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_social_networks_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_text_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_12_button_enable',
			'type'    => 'button_set',
