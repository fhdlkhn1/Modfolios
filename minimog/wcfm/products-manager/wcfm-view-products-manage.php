        ...
        <form id="wcfm_products_manage_form" class="wcfm">
            ...
            <div class="modfolio-form-card">
                ...
                <div class="modfolio-gallery-section">
                    ...
                    <input type="file" id="gallery-file-input" multiple accept="image/jpeg,image/png,image/gif,image/webp" style="display:none;">
...
jQuery(document).ready(function($) {
    ...
    // Browser file picker for gallery upload
    ...
    // Handle file input change - upload selected files
    ...
    // Upload files via AJAX (used by both file picker and drag-drop)
    function uploadDroppedFiles(files) {
        ...
        if (validFiles.length === 0) {
            alert('<?php _e("Please select valid image files (JPEG, PNG, GIF, WebP)", "wc-frontend-manager"); ?>');
            return;
        }

        // Show uploading state
        var $dropzone = $('#modfolio-dropzone');
        var originalHTML = $dropzone.find('h3').text();
        $dropzone.find('h3').text('Uploading...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response && response.success && response.data) {
                        ...
                        var attachment = {
                            id: data.id,
                            url: imgUrl,
                            sizes: data.sizes || { medium: { url: imgUrl } }
                        };
                ...
                complete: function() {
                    ...
                    if (uploaded >= total) {
                        ...
                        $dropzone.find('h3').text(originalHTML);
