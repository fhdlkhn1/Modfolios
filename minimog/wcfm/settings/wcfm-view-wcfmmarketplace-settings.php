...
$_membership_id = get_user_meta( $user_id, 'wcfm_membership', true );
if ( $_membership_id ) {
    $_membership_post = get_post( $_membership_id );
    if ( $_membership_post && ! is_wp_error( $_membership_post ) ) {
        $membership_type = $_membership_post->post_title;
    }
}
...
// ===== Theme Settings =====
$background_theme = isset($vendor_data['theme']['background']) ? $vendor_data['theme']['background'] : '#42A5D8';
$accent_color = isset($vendor_data['theme']['accent']) ? $vendor_data['theme']['accent'] : '#00c4aa';
$light_bg_color = isset($vendor_data['theme']['light_bg']) ? $vendor_data['theme']['light_bg'] : '#FFFEF4';
$dark_bg_color = isset($vendor_data['theme']['dark_bg']) ? $vendor_data['theme']['dark_bg'] : '#000';
...
// ===== Membership Check for Live Media Kit =====
$subscription_status = get_user_meta( $user_id, 'wcfm_subscription_status', true );
$membership_id = (int) get_user_meta( $user_id, 'wcfm_membership', true );
$allowed_membership_ids = array( 21878, 21879 ); // Pro and Elite
$has_media_kit_access = ( $subscription_status === 'active' && in_array( $membership_id, $allowed_membership_ids, true ) );

// Browser native file picker is used instead of WordPress media uploader
?>
...
<div class="collapse wcfm-collapse modfolio-settings-page" id="wcfm_settings">
    ...
    <div class="wcfm-collapse-content">
        ...
        <form id="wcfm_settings_form" class="modfolio-settings-form">
            ...
            <div class="modfolio-settings-layout">
                ...
                <div class="settings-column settings-left">
                        ...
                        <div class="section-content">
                            ...
                            <div class="social-links-grid">
                                <div class="figma-input-field">
                                    ...
                                    <span class="field-separator"></span>
                                    <input type="text" name="social[fb]" value="<?php echo esc_attr($facebook_url); ?>" placeholder="www.facebook.com/username">
                                ...
                                <div class="figma-input-field">
                                    ...
                                    <span class="field-separator"></span>
                                    <input type="text" name="social[linkedin]" value="<?php echo esc_attr($linkedin_url); ?>" placeholder="www.linkedin.com/in/username">
                                    <span type="button" class="copy-btn"><i class="wcfmfa fa-copy"></i></span>
                                </div>
                                <div class="figma-input-field">
                                    <span class="field-label"><?php _e('Twitter', 'wc-frontend-manager'); ?></span>
                                    <span class="field-separator"></span>
                                    <input type="text" name="social[twitter]" value="<?php echo esc_attr($twitter_url); ?>" placeholder="www.twitter.com/username">
                                    <span type="button" class="copy-btn"><i class="wcfmfa fa-copy"></i></span>
                                </div>
                                <div class="figma-input-field">
                                    <span class="field-label"><?php _e('Instagram', 'wc-frontend-manager'); ?></span>
                                    <span class="field-separator"></span>
                                    <input type="text" name="social[instagram]" value="<?php echo esc_attr($instagram_url); ?>" placeholder="www.instagram.com/username">
                                    <span type="button" class="copy-btn"><i class="wcfmfa fa-copy"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="settings-section" id="media-kit">
                        ...
                        <div class="section-content">
                        <?php if ( ! $has_media_kit_access ) :
                            wp_enqueue_style( 'wcfm-membership-restriction', plugins_url( 'css/membership-restriction.css', WP_PLUGIN_DIR . '/vendor-customshot/wcfm-custom-menus.php' ), array(), '1.0.0' );
                        ?>
                            <div class="membership-upgrade-box">
                                ...
                                <h2 class="upgrade-title"><?php _e( 'Unlock Live Media Kit', 'wc-frontend-manager' ); ?></h2>
                                <p class="upgrade-description">
                                    <?php _e( 'Showcase your social media stats to attract brands! The Live Media Kit feature is exclusive to our', 'wc-frontend-manager' ); ?>
                                    <span class="highlight"><?php _e( 'Premium & Elite members', 'wc-frontend-manager' ); ?></span>.
                                </p>
                                <div class="upgrade-benefits">
                                    <div class="benefit-item">
                                        ...
                                        <span class="benefit-text"><?php _e( 'Display verified social media statistics', 'wc-frontend-manager' ); ?></span>
                                    </div>
                                    <div class="benefit-item">
                                        <span class="benefit-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                                        </span>
                                        <span class="benefit-text"><?php _e( 'Instagram, TikTok, YouTube & Snapchat stats', 'wc-frontend-manager' ); ?></span>
                                    </div>
                                    <div class="benefit-item">
                                        <span class="benefit-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                                        </span>
                                        <span class="benefit-text"><?php _e( 'Attract more brand collaborations', 'wc-frontend-manager' ); ?></span>
                                    </div>
                                    <div class="benefit-item">
                                        <span class="benefit-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                                        </span>
                                        <span class="benefit-text"><?php _e( 'Stand out with a professional media kit', 'wc-frontend-manager' ); ?></span>
                                    </div>
                                </div>
                                <a href="<?php echo esc_url( home_url( '/pricing/' ) ); ?>" class="upgrade-btn">
                                    <?php _e( 'Upgrade to Premium', 'wc-frontend-manager' ); ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="settings-section" id="theme-settings">
                        ...
                        <div class="section-content">
                            <div class="field-group color-field figma-input-field">
                                <label class="field-label"><?php _e('Primary Color', 'wc-frontend-manager'); ?></label>
                                <span class="field-separator"></span>
                            ...
                            <div class="field-group color-field figma-input-field">
                                <label class="field-label"><?php _e('Secondary Color', 'wc-frontend-manager'); ?></label>
                                <span class="field-separator"></span>
                                <div class="color-input-wrap">
                            ...
                            <div class="field-group color-field figma-input-field">
                                <label class="field-label"><?php _e('Light Theme Background', 'wc-frontend-manager'); ?></label>
                                <span class="field-separator"></span>
                                <div class="color-input-wrap">
                                    <input type="color" name="theme[light_bg]" value="<?php echo esc_attr($light_bg_color); ?>" class="color-picker" id="light-bg-color-picker">
                                    <span class="field-separator"></span>
                                    <a type="button" class="edit-color-btn" data-target="light-bg-color-picker"><i class="wcfmfa fa-pencil-alt"></i></a>
                                </div>
                            </div>
                            <div class="field-group color-field figma-input-field">
                                <label class="field-label"><?php _e('Dark Theme Background', 'wc-frontend-manager'); ?></label>
                                <span class="field-separator"></span>
                                <div class="color-input-wrap">
                                    <input type="color" name="theme[dark_bg]" value="<?php echo esc_attr($dark_bg_color); ?>" class="color-picker" id="dark-bg-color-picker">
                                    <span class="field-separator"></span>
                                    <a type="button" class="edit-color-btn" data-target="dark-bg-color-picker"><i class="wcfmfa fa-pencil-alt"></i></a>
                                </div>
                            </div>
                            <div class="field-group reset-colors-field">
                                <label class="field-label"><?php _e('Reset to Default', 'wc-frontend-manager'); ?></label>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="reset-colors-toggle" style="margin-left: auto;">
...
<div class="modfolio-modal-overlay" id="tagline-modal" style="display: none;">
    <div class="modfolio-modal">
        <div class="modal-header">
            ...
            <span type="button" class="modal-close" id="close-tagline-modal"><i class="wcfmfa fa-times"></i></span>
        </div>
...
<div class="modfolio-modal-overlay" id="success-modal" style="display: none;">
    <div class="modfolio-modal success-modal">
        <div class="modal-content text-center">
            ...
            <p class="modal-text" style="color: #1a1a1a !important;"><?php _e('Your profile has been updated successfully.', 'wc-frontend-manager'); ?></p>
        </div>
    </div>
</div>
...
<!-- Avatar Crop Modal -->
<div class="modfolio-modal-overlay" id="avatar-crop-modal" style="display: none;">
    <div class="modfolio-modal avatar-crop-modal">
        <div class="modal-header">
            <h3><?php _e('Crop Avatar', 'wc-frontend-manager'); ?></h3>
            <button type="button" class="modal-close" id="close-crop-modal"><i class="wcfmfa fa-times"></i></button>
        </div>
        <div class="modal-body">
        ...
        <div class="modal-footer">
            <button type="button" class="modal-btn btn-cancel" id="cancel-crop"><?php _e('Cancel', 'wc-frontend-manager'); ?></button>
            <button type="button" class="modal-btn btn-confirm" id="save-crop"><?php _e('Crop & Upload', 'wc-frontend-manager'); ?></button>
        </div>
    </div>
</div>
...
#wcfm-main-contentainer .slider-container input[type="range"],
...
#wcfm-main-contentainer .slider-container input[type="range"]::-webkit-slider-thumb,
...
#wcfm-main-contentainer .slider-container input[type="range"]::-moz-range-thumb,
...
#wcfm-main-contentainer .slider-container input[type="range"]::-moz-range-track,
...
.avatar-crop-modal .modal-header h3 {
    margin: 0;
    font-size: 18px;
    color: #1a1a1a;
}
...
.avatar-crop-modal .modal-footer {
    display: flex;
...
jQuery(document).ready(function($) {
    ...
    // ===== Upload helper (shared by banner and avatar) =====
            ...
            success: function(response) {
                if (response && response.success && response.data) {
                    ...
                    if (data.sizes && data.sizes.medium) {
                        imgUrl = data.sizes.medium.url;
                    } else if (data.url) {
                        imgUrl = data.url;
                    }
                    callback(data.id, imgUrl);
                } else {
                    console.log('Upload error response:', response);
                    alert('Upload failed: ' + (response && response.data && response.data.message ? response.data.message : 'Unknown error'));
                }
            },
            error: function(xhr, status, error) {
                console.log('Upload AJAX error:', status, error, xhr.responseText);
                alert('Upload failed: ' + error);
            }
        });
    }

    // ===== Banner Upload (native file picker) =====
    $('#edit-banner-btn').on('click', function(e) {
        e.preventDefault();
        $('#banner-file-input').val('').trigger('click');
    });
    ...
    $('#banner-file-input').on('change', function() {
        ...
        var $btn = $('#edit-banner-btn');
        $btn.css('opacity', '0.5').css('pointer-events', 'none');
        uploadSingleImage(file, function(attachmentId, imgUrl) {
            $('#banner-input').val(attachmentId);
            $('.header-banner').css('background-image', 'url(' + imgUrl + ')');
    ...
    $('#edit-avatar-btn').on('click', function(e) {
        e.preventDefault();
        $('#avatar-file-input').val('').trigger('click');
    });
    ...
    // Close crop modal
    $('#close-crop-modal, #cancel-crop').on('click', function() {
        if (avatarCropper) {
            avatarCropper.destroy();
            avatarCropper = null;
        }
        $('#avatar-crop-modal').fadeOut(200);
    });
    ...
    $('#save-crop').on('click', function() {
        ...
        var $saveBtn = $(this);
        $saveBtn.prop('disabled', true).text('<?php _e('Uploading...', 'wc-frontend-manager'); ?>');
        ...
        canvas.toBlob(function(blob) {
            ...
            uploadSingleImage(croppedFile, function(attachmentId, imgUrl) {
                $('#gravatar-input').val(attachmentId);
                $('#avatar-preview').attr('src', imgUrl);

                // Cleanup and close
                avatarCropper.destroy();
                avatarCropper = null;
                $saveBtn.prop('disabled', false).text('<?php _e('Crop & Upload', 'wc-frontend-manager'); ?>');
                $('#avatar-crop-modal').fadeOut(200);
            });
        }, 'image/jpeg', 0.92);
    });
    ...
    var originalColors = {
        accent: $('#accent-color-picker').val(),
        bg: $('#bg-color-picker').val(),
        lightBg: $('#light-bg-color-picker').val(),
        darkBg: $('#dark-bg-color-picker').val()
    };

    $('#reset-colors-toggle').on('change', function() {
        if (this.checked) {
            $('#accent-color-picker').val('#00c4aa');
            $('#bg-color-picker').val('#42A5D8');
            $('#light-bg-color-picker').val('#FFFEF4');
            $('#dark-bg-color-picker').val('#000000');
        } else {
            $('#accent-color-picker').val(originalColors.accent);
            $('#bg-color-picker').val(originalColors.bg);
            $('#light-bg-color-picker').val(originalColors.lightBg);
            $('#dark-bg-color-picker').val(originalColors.darkBg);
        }
    });
