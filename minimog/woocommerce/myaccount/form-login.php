	...
	<div class="col-md-5">
		...
		<div class="woocommerce-form-wrap woocommerce-form-has-background woocommerce-form-login-wrap">
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>" name="login"
		...
		<div class="woocommerce-form-wrap woocommerce-form-register-wrap">
			...
			<form method="post"
				...
				<?php else : ?>
					...
					<p><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'minimog' ); ?></p>
