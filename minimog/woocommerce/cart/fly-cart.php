...
$shipping_calculator_is_enable    = 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) && wc_shipping_enabled();
...
<div id="popup-fly-cart" class="popup-fly-cart">
	<div class="inner">
		...
		<?php if ( $order_notes_is_enable && $order_notes_show_in_cart ) { ?>
			<?php
			$notes = ( function_exists( 'WC' ) && WC()->session ) ? WC()->session->get( 'minimog_order_notes', '' ) : '';
			?>
