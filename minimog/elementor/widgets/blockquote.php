...
class Widget_Blockquote extends Base {
	...
	private function add_content_section() {
		...
		$this->add_control( 'blockquote_content', [
			...
			'placeholder' => __( 'Enter your quote', 'minimog' ),
			'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'minimog' ),
			'separator'   => 'before',
		] );
	...
	private function add_box_style_section() {
		...
		$this->add_control( 'blockquote_icon_style', [
			'label'     => __( 'Blockquote Icon', 'minimog' ),
		...
		$this->add_control( 'blockquote_content_style', [
			'label'     => __( 'Blockquote Content', 'minimog' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_responsive_control( 'blockquote_content_spacing_bottom', [
			'label'     => __( 'Spacing Bottom', 'minimog' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
					'min' => 0,
		...
		$this->add_control( 'author_position_heading', [
			'label'     => __( 'Author Position', 'minimog' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
