...
<div class="cart-content">
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
			<thead>
			<tr>
				<th scope="col" class="col-product-info"><?php esc_html_e( 'Product', 'minimog' ); ?></th>
				<th scope="col" class="product-price"><?php esc_html_e( 'Price', 'minimog' ); ?></th>
				<th scope="col" class="product-quantity"><?php esc_html_e( 'Quantity', 'minimog' ); ?></th>
				<th scope="col" class="product-subtotal"><?php esc_html_e( 'Subtotal', 'minimog' ); ?></th>
			</tr>
			</thead>
			<tbody>
							...
							<div class="product-wrap">
								...
								<div class="product-info">
									...
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										'woocommerce_cart_item_remove_link', sprintf( '<a role="button" href="%s" class="remove btn-remove-from-cart" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s">%s</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_attr( $product_id ), esc_attr( $_product->get_sku() ), esc_attr( $cart_item_key ), esc_html__( 'Remove', 'minimog' ) ), $cart_item_key );
									?>
								</div>
							</div>
						</td>
