...
<path d="M28.1077 0.75H8.39234C4.17834 0.75 0.75 4.17834 0.75 8.39234V28.1077C0.75 32.3217 4.17834 35.75 8.39234 35.75H28.1077C32.3217 35.75 35.75 32.3217 35.75 28.1077V8.39234C35.75 4.17834 32.3217 0.75 28.1077 0.75ZM33.9459 28.1077C33.9459 31.3269 31.3269 33.9459 28.1077 33.9459H8.39234C5.17313 33.9459 2.55412 31.3269 2.55412 28.1077V8.39234C2.55412 5.17313 5.17313 2.55412 8.39234 2.55412H28.1077C31.3269 2.55412 33.9459 5.17313 33.9459 8.39234V28.1077ZM20.7344 16.595L27.5431 8.1088C27.8549 7.7202 27.7926 7.15247 27.4041 6.84065C27.0154 6.52897 26.4477 6.5911 26.1359 6.97978L19.5778 15.1535L13.0198 6.97978C12.9352 6.87443 12.8281 6.78941 12.7064 6.73098C12.5846 6.67255 12.4512 6.64221 12.3162 6.6422H7.00475C6.83473 6.6422 6.66817 6.69025 6.52428 6.78081C6.38038 6.87138 6.26501 7.00076 6.19147 7.15406C6.11792 7.30735 6.08919 7.4783 6.1086 7.64721C6.12801 7.81612 6.19475 7.97611 6.30114 8.10873L15.7656 19.905L8.95681 28.3912C8.64506 28.7798 8.70734 29.3475 9.09588 29.6593C9.25569 29.7879 9.45471 29.858 9.65984 29.8578C9.79503 29.858 9.92853 29.8277 10.0504 29.7693C10.1723 29.7109 10.2795 29.6257 10.364 29.5202L16.9222 21.3465L23.4802 29.5202C23.5647 29.6256 23.6718 29.7106 23.7936 29.769C23.9153 29.8275 24.0487 29.8578 24.1838 29.8578H29.4966C29.9948 29.8578 30.3987 29.454 30.3987 28.9557C30.3987 28.7258 30.3127 28.516 30.171 28.3566L20.7344 16.595ZM24.6166 28.0537L8.88508 8.44632H11.8834L27.6149 28.0537H24.6166Z" fill="white" stroke="white" stroke-width="1.5"/>
        ...
        <div class="customshots-request-wrapper">
            <button type="button"
                ...
                <?php esc_html_e('Request Custom Shootss', 'vendor-customshot'); ?>
            </button>
        </div>
    </div>
                ...
                <div class="modal-body customshot-modal-body">
                    ...
                    <form id="customshot-request-form">
                        ...
                        <div class="customshot-field customshot-field-brief">
                            ...
                            <textarea id="customshot-brief" name="brief" rows="1" placeholder="<?php esc_attr_e('Describe your vision or concept for the shoot', 'vendor-customshot'); ?>" required></textarea>
                        </div>
                    ...
                    <div id="customshot-success-view" style="display: none;">
                        <div class="customshot-success-container">
                            <div class="customshot-success-icon">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="32" cy="32" r="32" fill="#0CCAAE" fill-opacity="0.1"/>
                                    <circle cx="32" cy="32" r="24" fill="#0CCAAE" fill-opacity="0.2"/>
                                    <circle cx="32" cy="32" r="16" fill="#0CCAAE"/>
                                    <path d="M26 32L30 36L38 28" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>

                            <h3 class="customshot-success-title"><?php esc_html_e('Request Sent!', 'vendor-customshot'); ?></h3>
                            
                            <p class="customshot-success-message">
                                <?php esc_html_e('Your custom shoot request for', 'vendor-customshot'); ?> 
                                "<span id="success-shoot-title"></span>" 
                                <?php esc_html_e('has been successfully sent to the creator.', 'vendor-customshot'); ?>
                            </p>

                            <div class="customshot-success-details">
                                <div class="customshot-success-detail-item" id="success-budget-item" style="display: none;">
                                    <span class="detail-label"><?php esc_html_e('Offer Budget', 'vendor-customshot'); ?></span>
                                    <span class="detail-value" id="success-budget"></span>
                                </div>
                                <div class="customshot-success-detail-item" id="success-date-item" style="display: none;">
                                    <span class="detail-label"><?php esc_html_e('Timeline', 'vendor-customshot'); ?></span>
                                    <span class="detail-value" id="success-date"></span>
                                </div>
                            </div>

                            <button type="button" class="customshot-btn customshot-btn-return" id="return-to-profile-btn">
                                <?php esc_html_e('Return to Profile', 'vendor-customshot'); ?>
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="customshot-success-container">
                            <div class="customshot-success-icon">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <circle cx="32" cy="32" r="24" fill="#10B981" fill-opacity="0.2"/>
    ...
    <style>
        ...
        .customshot-field-brief label::after {
            transform: translateY(0%) !important;
        }
        .customshot-field-brief textarea {
            margin-bottom: 0;
        ...
        button:not(.mce-container button).customshot-btn-cancel {
        ...
        /* Success View Styles */
        .customshot-success-container {
            text-align: center;
            padding: 40px 20px;
        }

        .customshot-success-icon {
            margin: 0 auto 24px;
            width: 120px;
            height: 120px;
        }

        .customshot-success-icon svg {
            width: 100%;
            height: 100%;
        }

        .customshot-success-title {
            font-size: 24px;
            font-weight: 800;
            margin-bottom: 12px;
            color: #111;
        ...
        .customshot-success-detail-item {
            display: flex;
        ...
        .customshot-success-detail-item:last-child {
            border-bottom: none;
        }
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            var $form = $('#customshot-request-form');
            var $submitBtn = $form.find('.customshot-btn-submit');
            var $formView = $('#customshot-form-view');
            var $successView = $('#customshot-success-view');
            ...
            $form.on('submit', function(e) {
                ...
                var brief = $('#customshot-brief').val();
                var usageType = $('#customshot-usage').val();
                var budget = $('#customshot-budget').val();
                var shootDate = $('#customshot-date').val();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            // Populate success view with form data
                            $('#success-shoot-title').text(title);
                            
                            // Show budget if provided
                            if (budget) {
                                $('#success-budget').text('$' + budget);
                                $('#success-budget-item').show();
                            } else {
                                $('#success-budget-item').hide();
                            }
                            
                            // Show date if provided
                            if (shootDate) {
                                $('#success-date').text(shootDate);
                                $('#success-date-item').show();
                            } else {
                                $('#success-date-item').hide();
                            }
                            ...
                            alert(response.data.message || '<?php echo esc_js(__('An error occurred. Please try again.', 'vendor-customshot')); ?>');
                        }
                    },
                    error: function(xhr, status, error) {
                        $submitBtn.removeClass('loading').prop('disabled', false);
                        alert('<?php echo esc_js(__('An error occurred. Please try again.', 'vendor-customshot')); ?>');
                    }
                });
            });

            // Return to Profile button
            $('#return-to-profile-btn').on('click', function() {
                $('#customshotModal').modal('hide');
            });

            // Reset modal when closed
            $('#customshotModal').on('hidden.bs.modal', function() {
                // Hide success view and show form view
                $successView.hide();
                $formView.show();
...
function wcfm_customshots_plugin_init() {
    ...
    // Withdrawal menu (for vendors only, not admin)
    add_filter('wcfm_menus', 'wcfm_withdrawal_menus', 23);
}
...
function wcfm_customshots_load_styles($end_point) {
    ...
    switch ($end_point) {
        case 'wcfm-customshots':
            wp_enqueue_style('wcfm_customshots_css', $plugin_url . 'css/wcfm-style-customshots.css', array(), $WCFM->version);
            break;

        case 'wcfm-customshot-messages':
            wp_enqueue_style('wcfm_customshot_chat_css', $plugin_url . 'css/wcfm-style-chat.css', array(), $WCFM->version);
            break;
    }
}
...
/* ========================================
   Withdrawal - WCFM Integration (Vendors Only)
   ======================================== */

/**
 * Withdrawal Menu - Only for Vendors (not Admin)
 * Links to existing WCFM withdrawal page
 */
function wcfm_withdrawal_menus($menus) {
    global $WCFM;

    // Only show for vendors, not for admin
    if (!wcfm_is_vendor()) {
        return $menus;
    }

    // Don't show for admin even if they have vendor capabilities
    if (current_user_can('administrator') || current_user_can('manage_options')) {
        return $menus;
    }

    // Get WCFM withdrawal page URL (existing WCFM endpoint)
    $wcfm_page = get_wcfm_page();
    $withdrawal_url = wcfm_get_endpoint_url('withdrawal', '', $wcfm_page);

    $custom_menus = array(
        'withdrawal' => array(
            'label'    => __('Withdrawal', 'vendor-customshot'),
            'url'      => $withdrawal_url,
            'icon'     => 'wallet',
            'priority' => 30
        ),
