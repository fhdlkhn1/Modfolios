	...
	class Minimog_Redux {
		...
		public function setup() {
			$args = array(
				...
				'menu_title'      => __( 'Theme Options', 'minimog' ),

				// The text to appear on the page title.
				'page_title'      => __( 'Theme Options', 'minimog' ),

				'intro_text'                => wp_kses( sprintf( __( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating. <br/> <a href="%s" target="_blank">Need support?</a> | <a href="%s">Check Update</a>',
					'minimog' ), esc_url( 'https://thememove.ticksy.com/submit/#100019229' ), admin_url( 'admin.php?page=insight-core' ) ), array(
					'a'  => array(
						'target' => array(),
						'href'   => array(),
					),
		...
		public function set_default_settings() {
			$default_settings = [
				...
				'mobile_tabs_title_enable'                         => false,
				'mobile_tabs'                                      => [
					'home'     => true,
					'shop'     => true,
					'login'    => false,
				...
				'title_bar_search_title'                           => 'Search results for: ',
				'title_bar_home_title'                             => 'Blog',
				'title_bar_archive_category_title'                 => 'Category: ',
				'title_bar_archive_tag_title'                      => 'Tag: ',
				'title_bar_archive_author_title'                   => 'Author: ',
				'title_bar_archive_year_title'                     => 'Year: ',
				'title_bar_archive_month_title'                    => 'Month: ',
				'title_bar_archive_day_title'                      => 'Day: ',
				'title_bar_single_blog_title'                      => 'Blog',
				 ...
				 * Footer
				 */
				'footer_copyright_text'                            => 'Copyright &copy; 2025. All rights reserved.',
				 ...
				 * Shop Archive.
				 */
				'product_archive_title_bar_title'                  => 'Shop',
				...
				'error404_page_title'                                   => 'Oops!',
				'error404_page_sub_title'                               => 'Page not found!',
				...
				'promo_popup_heading'                     => 'Don’t Want To Miss Anything?',
				'promo_popup_description'                 => 'Be the first to see new arrivals, exclusive ideals and much more',
				'promo_popup_image'                       => array(
					'url' => MINIMOG_THEME_IMAGE_URI . '/promo-popup-image.jpg',
				),
				'promo_popup_button_style'                => 'flat',
				'promo_popup_button_text'                 => 'Get It Now',
