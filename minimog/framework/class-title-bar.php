...
if ( ! class_exists( 'Minimog_Title_Bar' ) ) {
	...
	class Minimog_Title_Bar {
		...
		public function get_list( $default_option = false, $default_text = '' ) {
			$options = array(
				'none'        => __( 'Hide', 'minimog' ),
				'standard-01' => sprintf( __( 'Standard %s', 'minimog' ), '01' ),
				'standard-02' => sprintf( __( 'Standard %s', 'minimog' ), '02' ),
				'standard-03' => sprintf( __( 'Standard %s', 'minimog' ), '03' ),
				'minimal-01'  => sprintf( __( 'Minimal %s', 'minimog' ), '01' ),
				'fill-01'     => sprintf( __( 'Fill %s', 'minimog' ), '01' ),
			);

			if ( $default_option === true ) {
				if ( $default_text === '' ) {
					$default_text = __( 'Default', 'minimog' );
				}
