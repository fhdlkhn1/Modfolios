...
.dark__theme .modfolio-kyc-tabs .tab-btn{
...
.dark__theme .modfolio-kyc-tabs .tab-btn:hover {
    border-color: #00c4aa !important;
    color: #00c4aa !important;
}

.modfolio-kyc-tabs .tab-btn.active,
.dark__theme .modfolio-kyc-tabs .tab-btn.active {
    /* background: #1a1a1a;
    border-color: #1a1a1a; */
...
/* #wcfm-content.container-wide:has(.modfolio-kyc-admin-page){
    z-index: 99999;
} */
                            ...
                            <div class="kyc-step-content">
                                ...
                                <div class="kyc-dropzone" id="kyc-doc-dropzone">
                                    ...
                                    <div class="kyc-file-preview" id="kyc-doc-preview" style="display:none;">
                                        <div class="kyc-preview-check">
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="20" cy="20" r="18" fill="#E8F8F5" stroke="#00C4B4" stroke-width="2"/>
                                                <path d="M13 20L18 25L27 16" stroke="#00C4B4" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </div>
...
.kyc-preview-info .kyc-preview-name { font-size: 14px; font-weight: 500; color: #c9d1d9; word-break: break-all; }
