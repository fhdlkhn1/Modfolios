...
= 3.9.2 - August 14, 2025 =
- Updated:
WPC Product Bundles plugin v.8.3.2
WPC Frequently Bought Together plugin v.7.6.8
WPC Smart Compare plugin v.6.4.8
WPC Smart Wishlist plugin v.5.0.2
WPC Smart Notification for WooCommerce plugin v.2.4.4
Multi Currency for WooCommerce plugin v.2.3.10.1
Revolution Slider plugin v.6.7.36
Updated outdated WooCommerce 10.1.0 templates
...
= 3.9.0 - July 15, 2025 =
- Updated:
Updated outdated WooCommerce 10.0.0 templates
Improved variable type handling in Linked Products widget for cleaner code
- Fixed:
Fixed Coupon label displaying raw HTML on the Cart page, the Checkout page.

= 3.8.9 - July 5, 2025 =
- Updated:
WPC Product Bundles plugin v.8.3.0
WPC Frequently Bought Together plugin v.7.6.6
WPC Product Tabs plugin v.4.2.2
WPC Smart Compare plugin v.6.4.7
WPC Smart Wishlist plugin v.5.0.1
Revolution Slider plugin v.6.7.35
Add trigger hook woocommerce_update_cart_validation on cart quantity update.
- Fixed:
Fix can not drag & drop widget to Elementor column when Column collapsed enable.

= 3.8.8 - June 23, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.9
WPC Frequently Bought Together plugin v.7.6.5
WPC Product Tabs plugin v.4.2.1
WPC Smart Compare plugin v.6.4.6
WPC Smart Wishlist plugin v.5.0.0
Multi Currency for WooCommerce plugin v.2.3.9.1
- Fixed:
Fix text_domain PHP warning

= 3.8.7 - June 11, 2025 =
- Updated:
Updated outdated templates of WooCommerce 9.9.0
WPC Product Bundles plugin v.8.2.8
WPC Frequently Bought Together plugin v.7.6.4
WPC Smart Notification for WooCommerce plugin v.2.4.3
...
= 3.8.6 - May 5, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.7
WPC Product Tabs plugin v.4.1.9
WPC Frequently Bought Together plugin v.7.6.3
WPC Smart Compare plugin v.6.4.5
Revolution Slider plugin v.6.7.33
Insight Product Brands plugin v.1.5.0
- Fixed:
Fix duplicate fields in Product brands with Woocommerce ver from 9.4.0
...
= 3.8.4 - April 9, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.6
WPC Smart Wishlist plugin v.4.9.9
WPC Product Tabs plugin v.4.1.8
WPC Frequently Bought Together plugin v.7.6.2
Sales Countdown Timer plugin v.1.1.6.1
Revolution Slider plugin v.6.7.31
- Fixed:
Fix the issue where the product media thumbnail stops working if the product page has a featured product widget
Fix show password input style on Checkout page

= 3.8.3 - March 17, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.3
Multi Currency for WooCommerce plugin v.2.3.7.1
- Fixed:
Fix WC Smart Coupon product add to cart function.
Fix variant price not update when variant change on Elementor template.

= 3.8.2 - March 1, 2025 =
- Updated:
Insight Core plugin v.2.7.4
WPC Frequently Bought Together plugin v.7.6.0
- Fixed:
Fix product brand show in breadcrumb instead of product category
Fix show password input style

= 3.8.1 - February 26, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.1
WPC Smart Compare plugin v.6.4.4
WPC Smart Notification plugin v.2.4.2
Revolution Slider plugin v.6.7.29
Updated outdated templates of WooCommerce 9.7.0
- Fixed:
WPC Bough Together Smart Rules error

= 3.8.0 - February 18, 2025 =
- Fixed:
Fix TranslatePress switcher
Fix missing nonce check in template_lazyload AJAX action.

= 3.7.0 - February 17, 2025 =
- Updated:
WPC Product Bundles plugin v.8.2.0
WPC Frequently Bought Together plugin v.7.5.9
Updated checkout script

= 3.6.4 - January 21, 2025 =
- Updated:
Updated outdated templates of WooCommerce 9.6.0
WPC Smart Compare plugin v.6.4.3
WPC Smart Wishlist plugin v.4.9.8
WPC Product Tabs plugin v.4.1.6

= 3.6.3 - January 13, 2025 =
- Updated:
WPC Product Bundles plugin v.8.1.7
WPC Frequently Bought Together plugin v.7.5.7
Update Search by SKU on Search Popup (includes variations)
Improvement popup search.
- Fixed:
Fix RTL Fly cart style

= 3.6.2 - December 30, 2024 =
- Updated:
WPC Product Bundles plugin v.8.1.6
WPC Frequently Bought Together plugin v.7.5.6
WPC Smart Wishlist plugin v.4.9.7
Multi Currency for WooCommerce plugin v.2.3.6.1
Sales Countdown Timer plugin v.1.1.5.1
Revolution Slider plugin v.6.7.25
Update Related Products Position: Below Product Summary

= 3.6.1 - December 18, 2024 =
- Updated:
Insight Product Brands plugin v.1.4.1
Updated outdated templates of WooCommerce 9.5.1

= 3.6.0 - December 17, 2024 =
- Updated:
Compatible with latest version of Elementor plugin
Product brands can import/export now.

= 3.5.6 - December 13, 2024 =
- Fixed:
Fix Bought together
Fix Free Shipping amount

= 3.5.5 - December 9, 2024 =
- Updated:
WPC Product Bundles plugin v.8.1.5
WPC Frequently Bought Together plugin v.7.5.2
WPC Smart Compare plugin v.6.4.2
WPC Smart Wishlist plugin v.4.9.6
WPC Product Tabs plugin v.4.1.5
WPC Smart Notification plugin v.2.4.1
Revolution Slider plugin v.6.7.23
- Fixed:
Fix the Dokan lists filter not working properly
Fix the Dokan Sidebar not showing

= 3.5.4 - November 20, 2024 =
- Updated:
WPC Smart Wishlist plugin v.4.9.5
- Fixed:
Fix Sale Countdown timer not displaying.

= 3.5.3 - November 19, 2024 =
- Updated:
WPC Product Bundles plugin v.8.1.4
WPC Frequently Bought Together plugin v.7.5.1
WPC Smart Compare plugin v.6.4.1
- Fixed:
Fix WPML product translate disabled case
Fix load_text_domain
Fix Contact form 7 response output style

= 3.5.2 - November 13, 2024 =
- Updated:
Updated out-date templates of WooCommerce 9.4.0
WPC Frequently Bought Together plugin v.7.4.2
WPC Product Bundles plugin v.8.1.3
- Fixed:
Fix Free shipping minimum amount for a thousand number

= 3.5.1 - November 6, 2024 =
- Updated:
Revolution Slider plugin v.6.7.21
- Fixed:
Fix jQuery UI function
Fix wrong table name
Don't update Elementor form to avoid PHP issue

= 3.5.0 - October 31, 2024 =
- Updated:
ThemeMove Addons For Elementor plugin v.2.0.1
WPC Frequently Bought Together plugin v.7.4.1
WPC Smart Wishlist plugin v.4.9.4
Multi Currency for WooCommerce plugin v.2.3.5.1
- Fixed:
Fix footer collapsible column not working with new Elementor version

= 3.4.9 - October 25, 2024 =
- Updated:
WPC Frequently Bought Together plugin v.7.3.0
Sales Countdown Timer (Premium) plugin v.1.1.4.1
- Fixed:
Fix js error when enabling sticky cart on Out of stock products
Fix PHP warning

= 3.4.8 - October 15, 2024 =
- Added:
Add button view all search results
- Updated:
Insight Core plugin v.2.7.1
Insight Swatches plugin v.1.8.1
WPC Smart Compare plugin v.6.3.0
WPC Smart Wishlist plugin v.4.9.3
WPC Product Bundles plugin v.8.1.2
Revolution Slider plugin v.6.7.20
blockUI styling on checkout.
- Fixed:
Fix widget Image Gallery not render properly on editor
Fix variant attribute value not being cleared properly when the variant is reset.

= 3.4.7 - September 25, 2024 =
- Updated:
WPC Smart Compare plugin v.6.2.9
WPC Smart Wishlist plugin v.4.9.1
WPC Frequently Bought Together plugin v.7.2.1
WPC Product Bundles plugin v.8.1.1
WPC Product Tabs plugin v.4.1.4
WPC Smart Notification for WooCommerce plugin v.2.4.0
Revolution Slider plugin v.6.7.19
- Fixed:
Fix Delivery Date Format on Single product
Improve SEO

= 3.4.6 - September 16, 2024 =
- Fixed:
Fix Elementor widgets used waypoint broken in Elementor 2.24.x

= 3.4.5 - September 13, 2024 =
- Fixed:
Browser back button not working properly after product variant changed.
Compatible with Dokan Pro
Fix PHP warning
Fix Quantity discount add button count
Fix missing domain
Fix out-date WooCommerce 9.3.0

= 3.4.4 - August 26, 2024 =
- Updated:
Updated out-date templates of WooCommerce 9.2.0
WPC Smart Compare plugin v.6.2.8
WPC Smart Wishlist plugin v.4.9.0
Revolution Slider plugin v.6.7.18

= 3.4.3 - August 8, 2024 =
- Updated:
Header Sticky Type option
WPC Frequently Bought Together plugin v.7.2.0
WPC Product Bundles plugin v.8.1.0
WPC Smart Wishlist plugin v.4.8.9
Revolution Slider plugin v.6.7.16
- Fixed:
Ignore hidden products from search page.
Force display avatar on my account page to avoid broken layout when option show_avatars disabled.
Compatible with Filter everywhere plugin

= 3.4.2 - July 30, 2024 =
- Updated:
WPC Frequently Bought Together plugin v.7.1.9
WPC Product Tabs plugin v.4.1.3
WPC Smart Compare plugin v.6.2.7
WPC Smart Wishlist plugin v.4.8.8
Multi Currency for WooCommerce plugin v.2.3.3.1
- Fixed:
Fix PHP warning
Fix top bar collapsible toggle

= 3.4.1 - July 12, 2024 =
- Updated:
Update url and share url on product variant found.
WPC Product Bundles plugin v.8.0.9
WPC Frequently Bought Together plugin v.7.1.6
WPC Smart Notification for WooCommerce plugin v.2.3.9
Revolution Slider plugin v.6.7.15
Insight Swatches plugin v.1.8.0
- Fixed:
Fix products slideshow image not display properly.
Fix some PHP warnings.
Fix selected variant swatches label not show on page load.
Fix slider loop mode on number of slides less than number to show.
Fix product header skin setting not work properly
...
= 3.3.6 - June 25, 2024 =
- Updated:
WPC Product Bundles plugin v.8.0.8
WPC Frequently Bought Together plugin v.7.1.5
Sales Countdown Timer (Premium) plugin v.1.1.3.1
- Fixed:
Fix Logo minetype as SVG can't get image size maybe raising CPU high usage

= 3.3.5 - June 19, 2024 =
- Fixed:
Out-date WC templates
Compatible with latest Elementor Pro plugin

= 3.3.4 - June 17, 2024 =
- Updated:
Improvement search category dropdown
Improvement Google indexing
Improvement single product sticky columns
Revolution Slider plugin v.6.7.13
WPC Smart Compare plugin v.6.2.6
WPC Smart Wishlist plugin v.4.8.7
WPC Product Bundles plugin v.8.0.7
WPC Frequently Bought Together plugin v.7.1.3
WPC Product Tabs plugin v.4.1.2

= 3.3.3 - May 17, 2024 =
- Updated:
Insight Core plugin v.2.7.0
Revolution Slider plugin v.6.7.11
WPC Smart Compare plugin v.6.2.5
WPC Smart Wishlist plugin v.4.8.6
WPC Product Bundles plugin v.8.0.5
WPC Frequently Bought Together plugin v.7.1.0
WPC Product Tabs plugin v.4.1.1
WPC Smart Notification for WooCommerce plugin v.2.3.8
ThemeMove Addons For Elementor plugin v.2.0.0 (Fix import MinimogWP templates)
- Fixed:
Fix PHP warning
Fix Theme Options - Navigation Typography not working
Hide Shipping Calculator when Woo Shipping disabled

= 3.3.2 - April 24, 2024 =
- Updated:
Compatible with Customer Reviews for WooCommerce plugin.
Revolution Slider plugin v.6.7.7

= 3.3.1 - April 19, 2024 =
- Updated:
Add theme setting allow to show title in mobile tabs.
Change date format for coupon in cart drawer to the same as site setting.
Compatible with YITH Product addons & extra options plugin.
Compatible with YITH Request a Quote plugin.
Revolution Slider plugin v.6.7.4
WPC Smart Compare plugin v.6.2.4
WPC Smart Wishlist plugin v.4.8.5
WPC Product Bundles plugin v.8.0.3
- Fixed:
Fix out-date WC templates
Fix product brands image size.
Fix question search not working.

= 3.2.3 - April 04, 2024 =
- Added:
Mini Cart elementor widget
New filter: 'minimog/modal_user_register/show_accept_field'
- Updated:
WPC Smart Compare plugin v.6.2.2
WPC Smart Wishlist plugin v.4.8.4
WPC Product Bundles plugin v.8.0.2
WPC Frequently Bought Together plugin v.7.0.7
WPC Product Tabs plugin v.4.1.0
- Fixed:
Fix drag move is not smooth in product carousel tab widget.
Fix review image gallery layout.
Fix style swiper-button-disabled on Single image carousel
Fix Fly cart RTL
Fix Category name tag for SEO optimization
Fix Button Popup Video widget not working
Fix Product bundle widget with Bundle plugin ver 8.0.0

= 3.2.2 - March 20, 2024 =
- Updated:
Remove unnecessary carousel controls in Modern slider widget
Update option allows choosing tag for Title in Widget Slider Slideshow
Add animation for Bought Together button when loading
WPC Smart Compare plugin v.6.2.1
WPC Smart Wishlist plugin v.4.8.3
WPC Product Bundles plugin v.7.3.9
WPC Frequently Bought Together plugin v.7.0.5
WPC Smart Notification for WooCommerce plugin v.2.3.7
Multi Currency for WooCommerce plugin v.2.3.2.1
- Fixed:
Fix Wishlist responsive
Fix out-date WC templates

= 3.2.1 - March 08, 2024 =
- Fixed:
fix product content below summary position not display properly in Elementor editor.
fix product tabs position.
fix product recent viewed section not showing.
fix toggles not working in quick view modal.

= 3.2.0 - February 16, 2024 =
- Updated:
