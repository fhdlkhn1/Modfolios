...
$wishlist_url = WPCleverWoosw::get_url( $key, true );
...
<a href="<?php echo esc_url( $wishlist_url ) ?>"
   class="wishlist-link header-icon has-badge header-wishlist-link hint--bounce hint--bottom <?php echo esc_attr( $link_classes ); ?>" aria-label="<?php esc_attr_e( 'Wishlist', 'minimog' ); ?>">
	<div class="icon">
