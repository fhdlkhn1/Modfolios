...
// Count custom shots with status 'new' or 'pending'
$custom_shots_count = get_posts(array(
...
$total_requests = count($custom_shots_count);
?>
        ...
        <span class="woocommerce-Price-amount amount">
            <bdi>
                <span class="woocommerce-Price-currencySymbol">
                    <span class="total__requests"><?php echo esc_html($total_requests); ?></span>
                </span> Requests
            </bdi>
        </span>
    </strong><br>
		...
		<?php if( apply_filters( 'wcfm_is_allow_reports', true ) && apply_filters( 'wcfm_is_allow_dashboard_reports', true ) ) { ?>
			<div class="wcfm_dashboard_wc_reports_sales">
				<div class="wcfm-container">
					...
					<div class="heading__wrapper">
						<h3 class="wcfm__dashboard_heading sales__chart_heading">Sales Chart</h3>
					</div>
