...
class Widget_Testimonial_Slideshow extends Static_Carousel {
	...
	public function get_title() {
		return __( 'Testimonial Slideshow', 'minimog' );
	}
	...
	private function add_layout_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '1',
			'options'      => [
				'1' => sprintf( __( 'Style %s', 'minimog' ), '01' ),
				'2' => sprintf( __( 'Style %s', 'minimog' ), '02' ),
			],
		...
		$this->add_control( 'content_width', [
			'label'       => __( 'Content Width', 'minimog' ),
			'type'        => Controls_Manager::SELECT,
			'description' => __( 'This option is triggered if Stretch Section is Enable', 'minimog' ),
			'default'     => 'default',
			'options'     => [
				'default' => __( 'Default', 'minimog' ),
	...
	private function update_controls() {
		...
		$this->add_responsive_control(
			'background_position',
			[
				'label'     => __( 'Background Position', 'minimog' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					''              => __( 'Default', 'minimog' ),
					'left top'      => __( 'Left Top', 'minimog' ),
					'left center'   => __( 'Left Center', 'minimog' ),
					'left bottom'   => __( 'Left Bottom', 'minimog' ),
					'right top'     => __( 'Right Top', 'minimog' ),
					'right center'  => __( 'Right Center', 'minimog' ),
					'right bottom'  => __( 'Right Bottom', 'minimog' ),
					'center top'    => __( 'Center Top', 'minimog' ),
					'center center' => __( 'Center Center', 'minimog' ),
					'center bottom' => __( 'Center Bottom', 'minimog' ),
				],
				'default'   => '',
				'selectors' => [
	...
	protected function after_slider() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'pagination' ); ?>>
	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'slide_show' ) ?>>
	...
	protected function get_image_placeholder_url( $width, $height ) {
		return 'https://via.placeholder.com/' . $width . 'x' . $height . '?text=' . esc_attr__( 'No+Image', 'minimog' );
	}
}
