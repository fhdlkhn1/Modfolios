				...
				$.ajax( {
					...
					success: function( response ) {
						if ( ! response.success ) {
							...
							// 2FA required - close login modal and open 2FA modal
							$modalLogin.MinimogModal( 'close' );
							if ( typeof window.modfolio2faOpen === 'function' ) {
								window.modfolio2faOpen( response.data['2fa_token'] );
							}
						} else {
