...
<div class="woocommerce-form-coupon-wrap">
	<div class="woocommerce-form-coupon-toggle">
		 ...
		 * @since 1.0.0
		 */
		echo apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Have a coupon?', 'minimog' ) . ' <a href="#" class="showcoupon link-transition-02" role="button" aria-label="' . esc_attr__( 'Enter your coupon code', 'minimog' ) . '" aria-controls="woocommerce-checkout-form-coupon" aria-expanded="false">' . esc_html__( 'Click here to enter your code', 'minimog' ) . '</a>' ) ?>
	</div>
