...
if ( ! class_exists( 'Minimog_Widgets' ) ) {
	class Minimog_Widgets {
		...
		public function enqueue_widgets_scripts() {
			...
			wp_enqueue_media();
			wp_enqueue_script( 'minimog-media', MINIMOG_THEME_URI . '/assets/admin/js/attach.js', [ 'jquery' ], MINIMOG_THEME_VERSION, true );
			wp_enqueue_script( 'minimog-admin-widgets-condition', MINIMOG_THEME_URI . '/assets/admin/js/wp-widgets-condition.js', [ 'jquery' ], MINIMOG_THEME_VERSION, true );
		}
	}
